...
export class EventsService {
  ...
  async getEventsWithWorkshops() {
    ...
    // Sort the workshops in each event based on the id in ascending order
    eventsWithWorkshops.forEach((event) => {
      event.workshops.sort((a, b) => a.id - b.id);
    });
  ...
  async getFutureEventWithWorkshops() {
    ...
    // Fetch events with workshops where the workshop start time is in the future
